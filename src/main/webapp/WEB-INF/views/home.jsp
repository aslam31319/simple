                ...
                <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #ed562d;">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="dropdown nav-link"><a href="#"
                                ...
                                <li class="nav-link"><img src="resources/cam.png" class="camimg" onclick="generateScreenshot()"
                                    height="30px" width="30px" ></li>
...
<div class="container" id="containerchart">
  <div class="row">
    ...
    <div class="col"><div id="barChart"></div></div>
    <div class="w-100"></div>
    <div class="col"><div id="pieChart" ></div></div>
    <div class="col"><div id="donutChart"></div></div>
  </div>
</div>

     
                <table id="example" class="table table-striped table-bordered"
                    style="width: 95%; background-color: white; display: none;" id="tabledata">
                    <thead>
                        <tr>
                            <th>Id</th>
                            <th>Name</th>
